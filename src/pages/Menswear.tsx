...
const menswearFilterSections = [
  {
    name: 'Style',
    options: ['Sherwani', 'Kurta Pajama', 'Modi Jacket', 'Indo Western'],
  },
  {
    name: 'Fabric',
    options: ['Silk', 'Jacquard', 'Velvet', 'Cotton'],
  },
  {
    name: 'Color',
    options: ['Cream', 'Beige', 'Gold', 'Black', 'Navy Blue', 'Maroon', 'Pink'],
  },
];
...
const Menswear = () => {
  ...
  const menswearFaqs = [
    ...
    },
    {
      ...
      answer: "Ready-to-ship sherwanis dispatch in 3-5 business days, with standard delivery (USPS/UPS) taking 7-10 business days transit or express (DHL) taking 3-5 business days transit. Custom-tailored sherwanis dispatch in 5-7 business days. For weddings, we recommend ordering 8-10 weeks in advance to allow time for fittings and alterations."
    },
    {
      ...
      <main className="pt-[90px] lg:pt-[132px] pb-16">
        <section className="relative h-64 md:h-96 flex items-center justify-center overflow-hidden">
          <picture className="absolute inset-0 w-full h-full">
            <source srcSet="/images/banners/menswear-banner.webp" type="image/webp" />
            <img
          ...
          >
            ...
            <p className="text-white/80 max-w-lg mx-auto">
              Sherwanis, kurta pajamas, and Indo-Western outfits for every celebration.
            </p>
          </motion.div>
        </section>
