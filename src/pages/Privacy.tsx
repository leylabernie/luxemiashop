            ...
            >
              <div className="space-y-8 text-muted-foreground">
                <p className="text-foreground font-medium">
                  LuxeMia ("LuxeMia," "we," "us," or "our") respects your privacy and is committed to protecting your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website luxemia.shop (the "Site"), make a purchase, or interact with us in any way. luxemia.shop is owned and operated by LuxeMia. Please read this policy carefully. By using our Site, you consent to the practices described herein.
                </p>
                ...
                <section>
                  ...
                  <div className="mt-4 p-6 bg-card border border-border rounded-lg space-y-2">
                    <p><strong className="text-foreground">LuxeMia</strong></p>
