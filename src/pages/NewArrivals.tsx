  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Shop the latest Indian ethnic wear online at LuxeMia. Discover new lehengas, sarees, co-ord sets, menswear and jewelry, with free U.S. standard shipping at $150 and above."
      ...
      <section className="border-t border-border/50 bg-card/20 py-12">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl text-center">
          ...
          <div className="text-sm text-muted-foreground space-y-3 leading-relaxed">
            ...
            <p>
              Whether you are shopping for a <strong>festival outfit</strong>, a <strong>wedding guest look</strong> or a <strong>bridal outfit</strong>, compare the exact listing before ordering. <strong>Free U.S. standard shipping applies at $150 and above</strong>; shipping is $14.99 below that.
            </p>
          </div>
        </div>
      </section>
