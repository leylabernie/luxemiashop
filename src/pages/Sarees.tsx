...
const Sarees = () => {
  ...
  useEffect(() => {
    const loadProducts = async () => {
      setIsLoading(true);
      try {
        const data = await fetchProducts(24, 'product_type:Saree OR tag:saree');
        setProducts(data);
      } catch (error) {
        ...
        <section className="relative h-64 md:h-80 flex items-center justify-center bg-gradient-to-b from-secondary to-background overflow-hidden">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Timeless handwoven sarees featuring traditional weaves and contemporary designs.
            </p>
          </motion.div>
        </section>
            ...
            <div className="flex-1">
              ...
              {!isLoading && products.length === 0 && (
                <div className="text-center py-16">
                  <p className="text-muted-foreground mb-4">No sarees found yet.</p>
                  <Link to="/collections">
