...
const weddingGuestFaqs = [
  ...
  },
  {
    ...
    answer: 'LuxeMia ships Indian wedding guest outfits to the United States, Canada, the United Kingdom, Australia, New Zealand, South Africa, and Mauritius. Standard shipping is free at $150 and above and $14.99 below $150. Confirm timing before ordering for a fixed wedding date.',
  },
  {
          ...
          <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
            ...
            <div className="space-y-5 text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="border-t border-border/30 pt-5 mt-6">
                ...
                <p>Set your budget before browsing and compare the current prices, product details, included pieces, and available sizes shown on each listing. U.S. shipping is free at $150 and above and costs a flat $14.99 below that.</p>
              </div>
