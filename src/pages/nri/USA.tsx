    ...
    config={{
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: 'Yes, we accept returns within 14 days of delivery. Items must be unworn with tags intact. Contact us via WhatsApp or email to initiate a return. We provide prepaid return labels for US customers.',
        },
        {
