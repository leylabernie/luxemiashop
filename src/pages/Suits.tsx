...
const suitFilterSections = [
  {
    name: 'Style',
    options: ['Anarkali', 'Sharara', 'Palazzo', 'Pakistani', 'Straight Cut'],
  },
  {
    name: 'Fabric',
    options: ['Georgette', 'Chinon', 'Silk', 'Net', 'Cotton', 'Velvet'],
  },
  {
    name: 'Color',
    options: ['Pink', 'Red', 'Green', 'Blue', 'Purple', 'Maroon', 'Black', 'Cream', 'Gold'],
  },
];
...
const Suits = () => {
  ...
  const filteredProducts = useMemo(() => {
    return filterAndSortProducts(womenOnlyProducts, activeFilters, priceRange, sortBy);
  }, [womenOnlyProducts, activeFilters, priceRange, sortBy]);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-[90px] lg:pt-[132px] pb-16">
        <section className="relative h-64 md:h-96 flex items-center justify-center overflow-hidden">
          <picture className="absolute inset-0 w-full h-full">
            <source srcSet="/images/banners/suit-banner.webp" type="image/webp" />
            <img
      ...
      <section className="border-t border-border bg-card/30 py-14">
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
          <h2 className="font-serif text-2xl mb-8 text-center">Frequently Asked Questions — Indian Suits</h2>
