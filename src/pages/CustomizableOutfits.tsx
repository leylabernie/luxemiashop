...
const customizableFaqs = [
  ...
  },
  {
    ...
    answer: 'Checkout currently accepts shipping addresses in seven countries only. U.S. standard shipping is $14.99 below $150 and free at $150 and above.',
  },
  {
        ...
        <section className="border-t border-border/30 bg-secondary/20 py-12">
          <div className="container mx-auto max-w-4xl px-4 lg:px-8">
            ...
            <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>LuxeMia checkout currently accepts shipping addresses in seven countries only. U.S. standard shipping is $14.99 below $150 and free at $150 and above.</p>
