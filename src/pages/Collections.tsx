        ...
        <section className="relative flex h-72 items-center justify-center overflow-hidden bg-[#211410] md:h-96">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-sm leading-relaxed text-white/85 md:text-base">
              Shop bridal lehengas, silk sarees, salwar kameez, sherwanis, and Indo-Western outfits. Review each listing for exact fabric, work, included pieces, sizing, stitching options, price, and availability. Free U.S. standard shipping at $150 and above.
            </p>
          </motion.div>
        </section>
      ...
      <section className="border-t border-border/50 bg-card/20 py-12">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <div className="prose prose-sm max-w-none text-muted-foreground space-y-3 text-sm leading-relaxed text-center">
            ...
            <p>
              Compare the available product images, selected options, measurements, current price, and delivery information. LuxeMia ships to the United States, Canada, the United Kingdom, Australia, New Zealand, South Africa, and Mauritius, with <strong>free U.S. standard shipping at $150 and above</strong> and a $14.99 rate below $150.
            </p>
          </div>
