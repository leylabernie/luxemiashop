...
const topicClusters = [
  ...
  },
  {
    ...
    categories: ['Wedding Guide', 'Wedding Style', 'Wedding Trends'],
  ...
  },
  {
    ...
    categories: ['Styling Tips', 'Style Tips'],
    shopLink: '/sarees',
  ...
  },
  {
    ...
    categories: ['Cultural Guide', 'Shopping Guide'],
    shopLink: '/suits',
