            ...
            >
              ...
              <div className="space-y-8 text-muted-foreground">
                ...
                <section id="shipping">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>LuxeMia currently ships to United States addresses only. Standard shipping is $12 below $135 and free at $135 and above. Please refer to our <a href="/shipping" className="text-primary hover:underline">Shipping Policy</a> for details.</li>
