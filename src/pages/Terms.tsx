            ...
            >
              ...
              <div className="space-y-8 text-muted-foreground">
                ...
                <section id="shipping">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>LuxeMia ships to the United States, Canada, the United Kingdom, Australia, New Zealand, South Africa, and Mauritius. U.S. standard shipping is $14.99 below $150 and free at $150 and above. Please refer to our <a href="/shipping" className="text-primary hover:underline">Shipping Policy</a> for details.</li>
