...
function sanitizeShopifyProductCopy(value: string): string {
  return (value || '')
    ...
    .replace(/standard shipping is free at \$150(?: and above|\+)? and \$12 below \$150/gi, 'Standard U.S. shipping is free at $150 and above and $14.99 below $150')
    ...
    .replace(/Ships within 1[–-]2 business days from the USA\.\s*Free shipping on orders over \$99\./gi, 'Free U.S. standard shipping at $150 and above. $14.99 below that. Tracking provided after dispatch.')
    .replace(/Free worldwide shipping to the seven supported destination countries via DHL\/USPS\/UPS \(7-10 business days\)/gi, 'Shipping is available to seven countries. U.S. standard shipping is $14.99 below $150 and free at $150 and above')
    .replace(/Free worldwide shipping to [^.]+?(?:arriving in |delivered in |within )?7-10 business days/gi, 'Shipping is available to seven countries. U.S. standard shipping is $14.99 below $150 and free at $150 and above')
    .replace(/Free worldwide shipping to [^.]+?via DHL\/USPS\/UPS/gi, 'Shipping is available to seven countries. U.S. standard shipping is $14.99 below $150 and free at $150 and above')
