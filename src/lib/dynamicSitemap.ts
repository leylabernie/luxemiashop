...
export const staticPages = [
  ...
  { loc: '/collections/indo-western-dresses', changefreq: 'weekly', priority: '0.9', title: 'Indo Western Dresses' },
  { loc: '/collections/kurta-sets', changefreq: 'weekly', priority: '0.9', title: 'Kurta Sets' },
  { loc: '/collections/ready-to-wear', changefreq: 'weekly', priority: '0.9', title: 'Ready to Wear Indian Outfits' },
  { loc: '/collections/suits-under-150', changefreq: 'weekly', priority: '0.9', title: 'Indian Suits Under $150' },
  { loc: '/collections/wedding-guest-outfits-under-250', changefreq: 'weekly', priority: '0.9', title: 'Indian Wedding Guest Outfits Under $250' },
  { loc: '/collections/sarees-under-100', changefreq: 'weekly', priority: '0.9', title: 'Sarees Under $100' },
  { loc: '/collections/groom-outfits', changefreq: 'weekly', priority: '0.9', title: 'Indian Groom Outfits' },
...
const generateImageTags = (images: string[], title: string, category: string): string => {
  ...
  return images.map(imageUrl => `
      <image:image>
        ...
        <image:caption>${escapeXml(`${title} - ${category} | LuxeMia Boutique`)}</image:caption>
      </image:image>`).join('');
};
