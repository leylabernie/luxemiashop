...
export const staticPages = [
  ...
  { loc: '/shipping/new-zealand', changefreq: 'monthly', priority: '0.6', title: 'Shipping to New Zealand' },
  { loc: '/shipping/south-africa', changefreq: 'monthly', priority: '0.6', title: 'Shipping to South Africa' },
  { loc: '/shipping/mauritius', changefreq: 'monthly', priority: '0.6', title: 'Shipping to Mauritius' },
