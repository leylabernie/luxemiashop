...
export const COLLECTION_SEO_CONFIG: Record<CollectionRoutePath, CollectionSeoConfig> = {
  ...
  '/collections/wedding-guest-dresses': {
    ...
    description: 'Shop guest wedding dresses at LuxeMia. Explore dressy Indian wedding guest lehengas, sarees, gowns, Anarkali suits, Indo Western looks, and festive occasion wear.',
    canonical: `${SITE_URL}/collections/wedding-guest-dresses`,
    ogImage: `${SITE_URL}/og/og-lehengas.jpg`,
    h1: 'Guest Wedding Dresses',
    semanticTitle: 'Guest wedding dresses, dressy Indian wedding guest silhouettes, wedding guest lehengas, sarees, gowns, and festive occasion wear',
    ...
    relatedCollections: [
      { label: 'Wedding Guest Outfit Guide', path: '/collections/wedding-guest-outfits' },
      { label: 'Wedding Lehengas', path: '/collections/wedding-lehengas' },
      { label: 'Party Wear Lehengas', path: '/collections/party-wear-lehengas' },
      { label: 'Designer Sarees', path: '/collections/designer-sarees' },
  ...
  '/collections/sharara-suits': {
    ...
    description: 'Shop sharara suits online at LuxeMia. Explore flowing sharara sets, designer sharara suits, wedding sharara suits, party wear sharara suits, Pakistani sharara suits, and embroidered festive styles.',
    canonical: `${SITE_URL}/collections/sharara-suits`,
    ogImage: `${SITE_URL}/og/og-suits.jpg`,
    h1: 'Sharara Suits',
    semanticTitle: 'Sharara suits, flowing wide-leg sharara sets, designer sharara suits, wedding sharara suits, party wear sharara suits, and Pakistani sharara outfits',
    primaryEntity: 'Sharara Suits',
    secondaryEntities: ['Designer sharara suits', 'Wide-leg sharara sets', 'Wedding sharara suits', 'Party wear sharara suits', 'Pakistani sharara suits', 'Festive sharara outfits', 'Embroidered sharara suits', 'Sharara suits online'],
    intent: 'category',
    relatedCollections: [
      { label: 'All Suits', path: '/suits' },
      { label: 'Salwar Kameez', path: '/collections/salwar-kameez' },
  ...
  '/collections/gharara-suits': {
    ...
    description: 'Shop gharara suits online at LuxeMia. Explore knee-flare gharara sets, designer gharara suits, wedding gharara suits, party wear gharara suits, Pakistani gharara suits, and embroidered festive styles.',
    canonical: `${SITE_URL}/collections/gharara-suits`,
    ogImage: `${SITE_URL}/og/og-suits.jpg`,
    h1: 'Gharara Suits',
    semanticTitle: 'Gharara suits, knee-flare gharara sets, designer gharara suits, wedding gharara suits, party wear gharara suits, and Pakistani gharara outfits',
    primaryEntity: 'Gharara Suits',
    secondaryEntities: ['Designer gharara suits', 'Knee-flare gharara sets', 'Wedding gharara suits', 'Party wear gharara suits', 'Pakistani gharara suits', 'Festive gharara outfits', 'Embroidered gharara suits', 'Gharara suits online'],
    intent: 'category',
    relatedCollections: [
      { label: 'All Suits', path: '/suits' },
      { label: 'Salwar Kameez', path: '/collections/salwar-kameez' },
