...
// Product handles that have a prerendered HTML file at /_prerender/product/<handle>.html.
// Populated by generate-routes.cjs at build time. Middleware uses this to avoid self-HTTP requests.
// This will be empty until the first successful build with SHOPIFY_STOREFRONT_TOKEN set.
