  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `LuxeMia ships ${product.category.toLowerCase()} to seven countries. U.S. standard shipping is free at $150 and above; international rates are shown at checkout.`
        }
      }
    ]
  };
