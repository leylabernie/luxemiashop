  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `LuxeMia ships ${product.category.toLowerCase()} to the United States, Canada, the United Kingdom, Australia, New Zealand, South Africa, and Mauritius. Standard shipping is free at $199 and above and $14.99 below $199.`
        }
      }
    ]
  };
    ...
    <div class="product-grid">
      ...
      <div class="product-info">
        ...
        <div class="shipping-info">
          <strong>Shipping:</strong> Free U.S. standard shipping at $199 and above. $14.99 below that. Tracking provided after dispatch.<br>
