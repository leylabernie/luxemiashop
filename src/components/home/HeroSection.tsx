...
const heroSlides: HeroSlide[] = [
  {
    ...
    alt: 'LuxeMia Boutique premium occasionwear real product banner',
  ...
  },
  {
    ...
    alt: 'LuxeMia Boutique wedding suit edit real product banner',
  ...
  },
  {
    ...
    alt: 'LuxeMia Boutique designer saree real product banner',
  ...
  },
  {
    ...
    alt: 'LuxeMia Boutique high-value festive picks real product banner',
