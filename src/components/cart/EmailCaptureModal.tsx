      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-background p-6 sm:p-8 z-[60] shadow-2xl max-h-[90vh] overflow-y-auto w-[calc(100%-2rem)]"
          >
            <button
              onClick={onClose}
