...
const US_SHIPPING_COPY = (
  <p>
    Free U.S. standard shipping applies at $150 and above; shipping is $14.99 below that threshold.
...
const LANDINGS: Record<CommercialLandingSlug, CommercialLandingDefinition> = {
  'sharara-suits': {
    ...
    editorialContent: (
      <>
        <p>
          Shop sharara suits online for mehendi, sangeet, wedding-guest looks and festive celebrations. Explore embroidered kurti-and-flared-bottom styles, compare colors and sizes, and check each listing for its exact included pieces. U.S. standard shipping is free at $150 and above.
        </p>
  ...
  'gharara-suits': {
    ...
    editorialContent: (
      <>
        <p>
          Find a gharara suit set online for wedding celebrations, festive gatherings and evening events. Compare embellished styles by color, fabric and size, then confirm the kurti, bottoms and dupatta included in your chosen design. U.S. standard shipping is free at $150 and above.
        </p>
