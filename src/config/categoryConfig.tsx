...
const LEHENGAS: CategoryConfig = {
  ...
  editorialContent: (
    <>
      ...
      <p>
        Free U.S. shipping applies at $150 and above and shipping is $14.99 below that. Tracking is provided after dispatch.
...
const SAREES: CategoryConfig = {
  ...
  subcategories: [
    ...
    occasionSub('bridal', 'Bridal', ['occasion:bridal', 'bridal'], {
      ...
      seoDescription: 'Shop bridal sarees online. Compare each listing\'s stated fabric, weave or work, blouse details, current price and availability. Free U.S. standard shipping at $150 and above.',
