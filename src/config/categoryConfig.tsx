...
const LEHENGAS: CategoryConfig = {
  ...
  subcategories: [
    ...
    occasionSub('mehendi', 'Mehendi', ['occasion:mehendi', 'occasion:mehndi', 'mehendi', 'mehndi']),
    occasionSub('haldi', 'Haldi', ['occasion:haldi', 'haldi']),
    occasionSub('sangeet', 'Sangeet', ['occasion:sangeet', 'sangeet']),
    occasionSub('party-wear', 'Party Wear', ['occasion:party', 'occasion:party wear', 'party wear', 'partwear']),
    styleSub('floral', 'Floral', ['style:floral', 'floral']),
    styleSub('embroidered', 'Embroidered', ['style:embroidered', 'embroidered']),
    styleSub('designer', 'Designer', ['style:designer', 'designer']),
    styleSub('mirror-work', 'Mirror Work', ['style:mirror', 'mirror work', 'mirror']),
    styleSub('jacket-lehenga', 'Jacket Lehenga', ['style:jacket', 'jacket lehenga']),
    styleSub('crop-top', 'Crop Top & Skirt', ['style:crop top', 'crop top', 'crop-top']),
    colorSub('red', 'Red'),
    colorSub('pink', 'Pink'),
    colorSub('maroon', 'Maroon'),
    colorSub('pastel', 'Pastel'),
    colorSub('ivory', 'Ivory'),
    colorSub('wine', 'Wine'),
    audienceSub('bridesmaid', 'Bridesmaid', ['role:bridesmaid', 'bridesmaid']),
    audienceSub('mother-of-bride', 'Mother of Bride', ['role:mother of bride', 'mother of bride', 'mother-of-bride']),
...
const SAREES: CategoryConfig = {
  ...
  subcategories: [
    ...
    occasionSub('wedding', 'Wedding', ['occasion:wedding', 'wedding']),
    occasionSub('reception', 'Reception', ['occasion:reception', 'reception']),
    occasionSub('party-wear', 'Party Wear', ['occasion:party', 'party wear']),
    occasionSub('festive', 'Festive', ['occasion:festive', 'festive']),
    styleSub('silk', 'Silk', ['fabric:silk', 'silk']),
    styleSub('banarasi', 'Banarasi', ['fabric:banarasi', 'banarasi']),
    styleSub('kanjeevaram', 'Kanjeevaram', ['fabric:kanjeevaram', 'fabric:kanchipuram', 'kanjeevaram', 'kanchipuram']),
    ...
    styleSub('embroidered', 'Embroidered', ['style:embroidered', 'embroidered']),
    styleSub('printed', 'Printed', ['style:printed', 'printed']),
    styleSub('designer', 'Designer', ['style:designer', 'designer']),
    styleSub('traditional', 'Traditional', ['style:traditional', 'traditional']),
    colorSub('red', 'Red'),
    colorSub('maroon', 'Maroon'),
    colorSub('pink', 'Pink'),
    colorSub('blue', 'Blue'),
...
const SUITS: CategoryConfig = {
  ...
  subcategories: [
    ...
    styleSub('sharara-set', 'Sharara Set', ['style:sharara set', 'sharara set']),
    styleSub('georgette-suit', 'Georgette', ['fabric:georgette', 'georgette']),
    styleSub('chinon-suit', 'Chinon', ['fabric:chinon', 'chinon']),
    styleSub('silk-suit', 'Silk', ['fabric:silk', 'silk']),
    styleSub('cotton-suit', 'Cotton', ['fabric:cotton', 'cotton']),
    styleSub('velvet-suit', 'Velvet', ['fabric:velvet', 'velvet']),
    occasionSub('wedding', 'Wedding', ['occasion:wedding', 'wedding']),
    occasionSub('party-wear', 'Party Wear', ['occasion:party', 'party wear']),
    occasionSub('festive', 'Festive', ['occasion:festive', 'festive']),
    occasionSub('casual', 'Casual', ['occasion:casual', 'casual']),
    colorSub('pink', 'Pink'),
    colorSub('red', 'Red'),
    colorSub('green', 'Green'),
    colorSub('blue', 'Blue'),
...
const MENSWEAR: CategoryConfig = {
  ...
  subcategories: [
    ...
    styleSub('kurta-pajama', 'Kurta Pajama', ['style:kurta pajama', 'kurta pajama', 'kurta']),
    styleSub('modi-jacket', 'Modi Jacket', ['style:modi jacket', 'modi jacket']),
    styleSub('indo-western', 'Indo Western', ['style:indo western', 'indo western', 'indowestern']),
    styleSub('bandhgala', 'Bandhgala', ['style:bandhgala', 'bandhgala']),
    styleSub('silk-menswear', 'Silk', ['fabric:silk', 'silk']),
    styleSub('jacquard', 'Jacquard', ['fabric:jacquard', 'jacquard']),
    styleSub('velvet-menswear', 'Velvet', ['fabric:velvet', 'velvet']),
    styleSub('cotton-menswear', 'Cotton', ['fabric:cotton', 'cotton']),
    styleSub('brocade', 'Brocade', ['fabric:brocade', 'brocade']),
    styleSub('raw-silk', 'Raw Silk', ['fabric:raw silk', 'raw silk']),
    occasionSub('wedding', 'Wedding', ['occasion:wedding', 'wedding']),
    occasionSub('engagement', 'Engagement', ['occasion:engagement', 'engagement']),
    occasionSub('reception', 'Reception', ['occasion:reception', 'reception']),
    occasionSub('festive', 'Festive', ['occasion:festive', 'festive']),
    colorSub('cream', 'Cream'),
    colorSub('beige', 'Beige'),
    colorSub('gold', 'Gold'),
    colorSub('black', 'Black'),
    colorSub('navy', 'Navy'),
    colorSub('maroon', 'Maroon'),
    colorSub('wine', 'Wine'),
    audienceSub('groom', 'Groom', ['role:groom', 'groom']),
    audienceSub('groomsmen', 'Groomsmen', ['role:groomsmen', 'groomsmen', 'groomsman']),
    audienceSub('nri-wedding', 'NRI Wedding', ['audience:nri', 'nri', 'destination wedding']),
    priceSub('under-200', 'Under $200', 0, 200),
    priceSub('premium-300-plus', 'Premium $300+', 300, 10000),
  ],
