...
export const localProducts: LocalProduct[] = [
  // === BRIDAL COLLECTION ===
  {
    ...
    description: "Step into your fairy tale in this breathtaking pastel pink bridal design. Handcrafted from the finest Pure Net fabric, this lehenga showcases extraordinary heavy work embroidery with careful attention to detail. The delicate blush tone is achieved through a specialized dyeing process that ensures color permanence and a subtle shimmer in every light. The voluminous skirt features cascading floral motifs interspersed with intricate zardozi work, while the matching blouse complements with equally detailed craftsmanship. The dupatta is edged with hand-stitched scalloped borders that frame your silhouette with romantic elegance. Perfect for the bride who envisions an ethereal, dreamlike entrance on her most magical day.",
  ...
  // === WEDDING COLLECTION ===
  {
    ...
    description: "Embrace regal sophistication with this sumptuous burgundy velvet lehenga that embodies the warm elegance of winter celebrations. The premium Italian velvet has been specially treated for a subtle sheen that photographs beautifully.",
  ...
  // === NEW BRIDAL LEHENGAS FROM WHOLESALESALWAR (JAN 2026) ===
  {
    ...
    description: "Command attention in this striking navy blue bridal design crafted from premium Heavy Net fabric. The deep midnight sapphire hue creates a sophisticated alternative to traditional bridal colors, perfect for the modern bride seeking distinction. Beautiful zari threadwork intertwines with thousands of hand-applied sequins to create mesmerizing patterns that catch every light. The intricate embroidery spans the entire lehenga, creating a cohesive work of art that seamlessly transitions from the flared skirt to the matching blouse. The coordinating dupatta features complementary embroidery with delicate borders.",
    price: convertPrice(12895),
