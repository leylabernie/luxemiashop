...
export const comboPages: ComboPageConfig[] = [
...

  {
    ...
    metaDescription: 'Shop maroon lehengas for Indian wedding guests. Online styles from $200-$500 with free U.S. shipping over $150. Maroon is rich, photogenic and not bridal red — perfect for wedding guests.',
    h1: 'Maroon Lehenga for Wedding Guest',
    heroSubtitle: 'Maroon is the perfect wedding guest color — rich, photogenic, and distinct from bridal red. Shop online maroon lehengas from $200-500 with free U.S. shipping over $150 on orders over $150.',
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, all our maroon wedding guest lehengas are available in Made to Measure at no extra cost. We custom-stitch to your exact measurements, with confirm timing before ordering and 7-10 day shipping to the United States. Free U.S. shipping over $150.',
        ],
      },
    ],
    faqs: [
      ...
      { question: 'When should I order my maroon lehenga?', answer: 'Order at least 4-6 weeks before the wedding date. Indian ethnic wear ships from India — even online items take 10-14 days door-to-door, and custom-stitched items take 3-4 weeks. At LuxeMia, ready-to-wear dispatches in 3-5 business days and Made to Measure in 5-7 business days.' },
    ],
    relatedLinks: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our emerald green lehengas are available in Made to Measure at no extra cost. Order at least 4-6 weeks before the wedding for custom stitching. Free U.S. shipping over $150 to the United States.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our royal blue lehengas are available with Made to Measure at no extra cost. Order 4-6 weeks before the wedding for custom stitching. Free U.S. shipping over $150.',
        ],
      },
    ],
    faqs: [
...

  {
    ...
    metaDescription: 'Shop pink lehengas for Indian wedding guests. From soft blush pink to bold fuchsia, online from $180-$450. Free shipping to the United States on orders over $150.',
    h1: 'Pink Lehenga for Wedding Guest',
    heroSubtitle: 'Pink is the most versatile wedding guest color — from soft blush to bold fuchsia. Shop online pink lehengas from $180-450 with free U.S. shipping over $150.',
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our pink lehengas are available in Made to Measure at no extra cost. We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the wedding for custom stitching.',
        ],
      },
    ],
    faqs: [
...

  {
    ...
    metaDescription: 'Shop purple lehengas for Indian wedding guests. From deep eggplant to soft lavender, online from $200-$500. Free shipping to the United States on orders over $150.',
    h1: 'Purple Lehenga for Wedding Guest',
    heroSubtitle: 'Purple is a royal, photogenic wedding guest color — from deep eggplant to soft lavender. Shop online purple lehengas from $200-500 with free U.S. shipping over $150.',
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our purple lehengas are available in Made to Measure at no extra cost. We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the wedding.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our wine lehengas are available in Made to Measure at no extra cost. We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the wedding for custom stitching.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our navy blue lehengas are available in Made to Measure at no extra cost. We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the wedding.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our maroon reception lehengas are available in Made to Measure at no extra cost. Order 4-6 weeks before the wedding. Free U.S. shipping over $150 to the United States.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our black lehengas feature heavy gold zari and sequin work that makes them appropriate for cocktail-style wedding events. Available in Made to Measure at no extra cost. Free U.S. shipping over $150 to the United States.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, our pastel lehengas are available in Made to Measure at no extra cost. We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the wedding. Pastels are especially popular for spring and summer weddings — order early as they sell out by March.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, we offer Made to Measure on every anarkali at no extra cost — essential for the mother of the bride, who needs a perfect fit. We custom-stitch to your exact measurements with confirm timing before ordering and 7-10 day shipping to the United States. Free U.S. shipping over $150.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, we offer Made to Measure on every lehenga at no extra cost — essential for bridesmaids who need a coordinated look with consistent fit. We custom-stitch to each bridesmaid measurements. Order 6-8 weeks before the wedding for the full bridal party. Free U.S. shipping over $150.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, all our anarkali suits are available in Made to Measure at no extra cost. We custom-stitch to your exact measurements. Order 4-6 weeks before the wedding. Free U.S. shipping over $150 to the United States.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, all our silk sarees come with a custom-stitched blouse at no extra cost (Made to Measure). We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the wedding for custom blouse stitching.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, we offer Made to Measure on every lehenga at no extra cost — essential for the mother of the bride, who needs a perfect, comfortable fit. We custom-stitch to your exact measurements with confirm timing before ordering. Free U.S. shipping over $150 to the United States.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, we offer Made to Measure on every sherwani at no extra cost — essential for the groom, who needs a perfect fit. We custom-stitch to his exact measurements with confirm timing before ordering. Free U.S. shipping over $150 to the United States. Order 6-8 weeks before the wedding.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, we offer Made to Measure on every kurta at no extra cost. We custom-stitch to his exact measurements with confirm timing before ordering. Free U.S. shipping over $150 to the United States. Order 4-6 weeks before the wedding.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, we offer Made to Measure on every sharara at no extra cost. We custom-stitch to your exact measurements with confirm timing before ordering. Free U.S. shipping over $150 to the United States. Order 4-6 weeks before the wedding.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, all our georgette sarees come with a custom-stitched blouse at no extra cost (Made to Measure). We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the reception.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Pair with a custom-stitched blouse (essential for sarees), gold or kundan jewelry (necklace set, jhumkas, bangles), and a maang tikka. For footwear, embellished flats. At LuxeMia, all our Banarasi silk sarees come with a custom-stitched blouse at no extra cost. Free U.S. shipping over $150 to the United States.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Pair with a custom-stitched blouse, temple jewelry (the traditional South Indian bridal jewelry — gold necklaces with red or green stones), and a gajra (flower garland) in the hair. At LuxeMia, all our Kanjivaram sarees come with a custom-stitched blouse at no extra cost. Free U.S. shipping over $150.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, all our chiffon sarees come with a custom-stitched blouse at no extra cost (Made to Measure). We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the wedding.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, all our silk sarees come with a custom-stitched blouse at no extra cost (Made to Measure). We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the festival.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Popular organza saree colors for engagements include pastel pink, mint green, ivory, and champagne for daytime events; deep jewel tones (emerald, sapphire, wine) for evening events. Floral print organza sarees are also trending for 2026 engagements. At LuxeMia, all our organza sarees come with a custom-stitched blouse at no extra cost. Free U.S. shipping over $150.',
        ],
      },
    ],
    faqs: [
    ...
    guideSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'At LuxeMia, all our georgette sarees come with a custom-stitched blouse at no extra cost (Made to Measure). We ship to the United States with free U.S. shipping over $150. Order 4-6 weeks before the wedding. For complete draping instructions, see our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">non-Indian wedding guest guide</a>.',
        ],
      },
    ],
    faqs: [
