...
function enrichDescription(
  ...
  details.push(
    "Shipping is available to the United States, Canada, the United Kingdom, Australia, New Zealand, South Africa, and Mauritius. U.S. standard shipping is $14.99 below $199 and free at $199 and above. Tracking is provided after dispatch. Review the product page for current availability and exact details."
  );
