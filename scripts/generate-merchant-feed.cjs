...
const CATEGORY_OCCASIONS = {
  ...
  'designer lehengas': 'red carpet events, celebrations',
...
const FABRIC_DETAILS = {
  ...
  'Silk': 'Silk fabric with natural sheen and rich texture. Comfortable for extended wear.',
  ...
  'Velvet': 'Velvet with soft pile and soft hand-feel. Perfect for winter celebrations.',
...
function enrichDescription(desc, category, fabric, work, color) {
  ...
  const fabricStr = fabric || 'Quality';
  ...
  // Get fabric details
  const fabricDetail = FABRIC_DETAILS[fabricStr] || `Quality ${fabricStr} fabric with quality workmanship.`;
  ...
  enriched += `Work & Craftsmanship: ${workStr} technique made with care. `;
  ...
  enriched += `Shipping: Free worldwide shipping on orders over $300. Dispatch: 3-5 business days (readymade), 5-7 business days (custom/alterations). Delivery: 3-5 business days via DHL Express, 7-10 business days via USPS/UPS standard. `;
...
const products = [
  // ── BRIDAL LEHENGAS ──
  { id: "bridal-001", handle: "ethereal-pastel-pink-bridal-lehenga", title: "Ethereal Pastel Pink Bridal Lehenga", description: "Step into your fairy tale in this breathtaking pastel pink bridal design. Handcrafted from the finest Pure Net fabric, this lehenga showcases extraordinary heavy work embroidery that has taken careful attention to detail. The delicate blush tone is achieved through a specialized dyeing process that ensures color permanence and a subtle shimmer in every light.", price: convertPrice(15895), originalPrice: convertPrice(22076), image: "https://kesimg.b-cdn.net/images/650/2025y/December/59570/Pastel-Pink-Pure-Net-Bridal-Wear-Heavy-Work-Readymade-Bridal-Lehenga-Choli-RIYAASAT-10243(1).jpg", category: "Bridal Lehengas", fabric: "Pure Net", color: "Pastel Pink", work: "Heavy Embroidery" },
  ...
  { id: "designer-004", handle: "heavy-silk-dusty-pink-mirror-work-lehenga", title: "Heavy Silk Dusty Pink Mirror Work Lehenga", description: "Romance personified in this dreamy dusty pink Heavy Silk lehenga adorned with beautiful mirror work. Perfect for engagement ceremonies and pre-wedding celebrations.", price: convertPrice(10995 * 3), originalPrice: convertPrice(15062 * 3), image: "https://kesimg.b-cdn.net/images/650/2025y/December/59605/Dusty-Pink-Heavy-Silk-Party-Wear-Mirror-Work-Lehenga-Choli-Alizeh---Mirror-Maze--3612-1012(1).jpg", category: "Designer Lehengas", fabric: "Heavy Silk", color: "Dusty Pink", work: "Mirror Work" },
  { id: "designer-005", handle: "organza-lavender-bridal-heavy-work-lehenga", title: "Organza Lavender Bridal Heavy Work Lehenga", description: "Step into ethereal elegance with this enchanting lavender Organza bridal lehenga. The delicate fabric combined with heavy embroidery work creates a beautiful piece fit for the discerning bride.", price: convertPrice(11295 * 3), originalPrice: convertPrice(15908 * 3), image: "https://kesimg.b-cdn.net/images/650/2025y/November/59368/Lavender-Organza-Bridal-Wear-Heavy-Work-Bridal-Lehenga-Choli-Aarohi-3474-2918-F(1).jpg", category: "Designer Lehengas", fabric: "Organza", color: "Lavender", work: "Heavy Work" },
  { id: "designer-006", handle: "organza-red-bridal-heavy-work-lehenga", title: "Organza Red Bridal Heavy Work Lehenga", description: "The timeless allure of bridal red reimagined in Organza fabric. This stunning lehenga features intensive heavy work embroidery that creates depth and dimension throughout.", price: convertPrice(11295 * 3), originalPrice: convertPrice(15908 * 3), image: "https://kesimg.b-cdn.net/images/650/2025y/November/59368/Red-Organza-Bridal-Wear-Heavy-Work-Bridal-Lehenga-Choli-Aarohi-3474-2918-E(1).jpg", category: "Designer Lehengas", fabric: "Organza", color: "Red", work: "Heavy Work" },

  // ── SAREES (Wedding) ──
  { id: "saree-001", handle: "mint-green-kanchipuram-silk-wedding-saree", title: "Mint Green Kanchipuram Silk Wedding Saree", description: "Experience the grandeur of South Indian tradition with this beautiful mint green Kanchipuram-inspired Viscose Silk saree. The delicate mint shade represents new beginnings and prosperity.", price: convertPrice(12195), originalPrice: convertPrice(16938), image: "https://kesimg.b-cdn.net/images/650/2025y/December/59744/Mint-Green-Viscose-Silk-Wedding-Wear-Weaving-Work-Wedding-Saree-Kanchipuram-Couture-3176-B(1).jpg", category: "Wedding Sarees", fabric: "Viscose Silk", color: "Mint Green", work: "Weaving Work" },
  { id: "saree-002", handle: "royal-pink-kanchipuram-silk-wedding-saree", title: "Royal Pink Kanchipuram Silk Wedding Saree", description: "A celebration of feminine grace in royal pink, this Viscose Silk saree channels the elegance of Kanchipuram's legendary weaving traditions.", price: convertPrice(12195), originalPrice: convertPrice(16938), image: "https://kesimg.b-cdn.net/images/650/2025y/December/59744/Pink-Viscose-Silk-Wedding-Wear-Weaving-Work-Wedding-Saree-Kanchipuram-Couture-3176(1).jpg", category: "Wedding Sarees", fabric: "Viscose Silk", color: "Pink", work: "Weaving Work" },
  ...
  { id: "saree-005", handle: "antique-gold-kanchipuram-silk-wedding-saree", title: "Antique Gold Kanchipuram Silk Wedding Saree", description: "Capture the essence of rich elegance with this magnificent antique gold Viscose Silk saree that radiates warmth and prosperity.", price: convertPrice(11545), originalPrice: convertPrice(16035), image: "https://kesimg.b-cdn.net/images/650/2025y/December/59744/Gold-Viscose-Silk-Wedding-Wear-Weaving-Work-Wedding-Saree-Kanchipuram-Couture-3131(1).jpg", category: "Wedding Sarees", fabric: "Viscose Silk", color: "Gold", work: "Weaving Work" },
  ...
  { id: "mens-001", handle: "grey-art-silk-groom-sherwani", title: "Grey Art Silk Groom Sherwani", description: "Command attention on your special day with this distinguished grey Art Silk sherwani featuring beautiful hand embroidery.", price: convertPrice(14295), originalPrice: convertPrice(19854), image: "https://kesimg.b-cdn.net/images/650/2025y/October/59064/Grey-Art-Silk-Wedding-Wear-Hand-Embroidery-Readymade-Groom-Sherwani-4032(1).jpg", category: "Groom Sherwanis", fabric: "Art Silk", color: "Grey", work: "Hand Embroidery" },
  ...
  { id: "mens-008", handle: "maroon-banarasi-jacquard-sherwani", title: "Maroon Banarasi Jacquard Sherwani", description: "Embrace passionate elegance with this stunning maroon Banarasi Jacquard sherwani featuring beautiful hand embroidery.", price: convertPrice(28395), originalPrice: convertPrice(39438), image: "https://kesimg.b-cdn.net/images/650/2025y/October/59064/Maroon-Banarasi-Jacquard-Wedding-Wear-Hand-Embroidery-Readymade-Groom-Sherwani-4024(1).jpg", category: "Groom Sherwanis", fabric: "Banarasi Jacquard", color: "Maroon", work: "Hand Embroidery" },
...
function generateXML() {
  const items = products.map(p => {
    ...
    <g:shipping>
      ...
      <g:transit_time>3-5 business days</g:transit_time>
    </g:shipping>
    <g:shipping>
      <g:country>US</g:country>
