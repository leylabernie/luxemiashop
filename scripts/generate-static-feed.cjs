...
function sanitizeShippingAndBoilerplate(text) {
  return text
    ...
    .replace(/Free delivery over \$350,?\s*7-10 business days to the seven supported destination countries via [^.]+\./gi, CURRENT_SHIPPING_SUMMARY)
    .replace(/Fast Worldwide Shipping - Free shipping on orders over \$350, delivered in 7-10 business days to the seven supported destination countries/gi, CURRENT_SHIPPING_SUMMARY)
    .replace(/Shipping: Free shipping on orders over \$350, delivered within 7-10 business days to the seven supported destination countries/gi, CURRENT_SHIPPING_SUMMARY)
    .replace(/Shipping: Free delivery over \$350, 7-10 business days to the seven supported destination countries via premium courier services/gi, CURRENT_SHIPPING_SUMMARY)
    ...
    .replace(/7-10 business days to the seven supported destination countries/gi, 'tracking is provided after dispatch to supported destinations')
    .replace(/the seven supported destination countries/gi, 'supported destinations')
