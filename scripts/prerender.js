...
const FAQ_PAGE_SCHEMA = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'In-stock ready-to-ship items leave LuxeMia within 2 business days. Carrier transit time begins after dispatch.',
      },
    },
    {
      '@type': 'Question',
...
const routes = [
  {
    ...
    content: `
      ...
      <p>Free US shipping over $150. $12 flat below that. Ships within 2 business days.</p>
    `,
  },
  {
       path: '/suits',
  ...
  },
  {
    ...
    description: 'Browse all products at LuxeMia. Designer lehengas, silk sarees, salwar suits, sherwanis & more. Free US shipping over $150.',
    h1: 'All Products',
    content: `
  ...
  },
  {
    ...
    description: 'Shop bridal lehengas at LuxeMia. Designer bridal lehenga choli in silk, velvet & net. Handcrafted embroidery, luxurious fabrics. Free US shipping.',
  ...
  },
  {
    ...
    h1: 'Our Story',
    content: '<p>LuxeMia was born from a passion for preserving India\'s rich textile heritage while making Indian ethnic wear accessible within the United States. We work directly with skilled makers across India to bring you authentic, beautifully made pieces.</p>',
  },
  {
    path: '/size-guide',
  ...
  },
  {
    ...
    content: `<p>Find answers to common questions about LuxeMia orders, shipping, returns, sizing, custom stitching, fabrics, and more.</p>
      ...
      <p>In-stock ready-to-ship items leave LuxeMia within 2 business days. Carrier transit time begins after dispatch.</p>
  ...
  },
  {
    ...
    description: 'Learn how LuxeMia US shipping and checkout taxes work for ready-to-ship Indian ethnic wear.',
    h1: 'Shipping & Customs',
    content: `
  ...
  },
  {
    ...
    description: 'Shop the latest arrivals at LuxeMia. New designer lehengas, sarees & suits added weekly. Free US shipping over $150.',
    h1: 'New Arrivals',
    content: `
  ...
  },
  {
    ...
    description: 'Shop Indo-Western fusion wear at LuxeMia. Modern ethnic suits, fusion lehengas & contemporary Indian outfits. Free US shipping over $150.',
  ...
  },
  {
    ...
    description: 'Indian ethnic wear for NRIs. Shop bridal lehengas, wedding sarees & festive outfits from abroad. Free US shipping over $150.',
    h1: 'NRI Collection',
    content: `
      <p>Curated for the global Indian. Shop authentic ethnic wear from anywhere in the world with free US shipping to the United States. No compromises on quality or authenticity.</p>
  ...
  },
  {
    ...
    description: 'Shop Indian ethnic wear online in the USA. Bridal lehengas, silk sarees, salwar suits with free US shipping across America. Authentic Indian craftsmanship.',
    h1: 'Indian Ethnic Wear USA',
    content: `
      <p>Shopping for Indian ethnic wear in the USA? LuxeMia offers authentic bridal lehengas, silk sarees, and designer suits with free US shipping across America.</p>
      <h2>Free Shipping to the USA</h2>
      <p>Enjoy free standard shipping on orders over $150 to the contiguous United States. Most orders arrive within 7-12 business days via DHL Express with full tracking. Express shipping (3-5 days) also available.</p>
  ...
  },
  {
    ...
    title: 'United States Shipping Only — Buy Indian Clothes Online | LuxeMia',
    description: 'LuxeMia currently ships ready-to-ship Indian ethnic wear to United States addresses only.',
    h1: 'United States Shipping Only',
    content: `
      <p>LuxeMia currently ships ready-to-ship Indian ethnic wear to United States addresses only.</p>
      <h2>Free Shipping Coast to Coast</h2>
      <p>Enjoy free standard shipping on orders over $150 to every Canadian province and territory. Standard delivery takes 10-14 business days with full tracking. Express shipping (5-7 days) also available.</p>
      ...
      <h2>United States Shipping Only</h2>
      <p>Browse <a href="/lehengas">lehengas</a>, <a href="/sarees">sarees</a>, <a href="/suits">salwar kameez</a>, and <a href="/menswear">menswear</a> for US delivery.</p>
    `,
  },
  // --- NRI sub-pages ---
  {
    ...
    content: `
      <p>LuxeMia delivers authentic Indian ethnic wear straight to your doorstep in the USA. Shop bridal lehengas, silk sarees, salwar kameez, and designer sherwanis with free US shipping on orders over $150.</p>
      <h2>Free Shipping Across America</h2>
      <p>Standard shipping takes 7-12 business days via DHL Express with full tracking. Express shipping (3-5 business days) is also available at checkout. Free standard shipping on all orders over $150 to the contiguous United States.</p>
      <h2>US Customs Information</h2>
      <p>Duties, taxes, and carrier processing fees may apply based on the product classification, shipment value, and current US customs rules. These charges are not included unless checkout explicitly states otherwise.</p>
      <h2>Shop by Category</h2>
      <ul>
  ...
  },
  {
    ...
    description: 'Shop Indian ethnic wear online in the United States. Bridal lehengas, silk sarees & salwar suits with free US shipping coast to coast. 10-14 day delivery.',
    h1: 'United States Shipping Only',
    content: `
      <p>LuxeMia delivers authentic Indian ethnic wear to the United States. Shop bridal lehengas, silk sarees, salwar kameez, and designer sherwanis with free US shipping on orders over $150.</p>
      <h2>Free Shipping Coast to Coast</h2>
  ...
  // --- Occasion landing pages ---
  {
    ...
    description: 'Shop Diwali outfits for women at LuxeMia. Lehengas, anarkali suits & sarees in gold, red & festive colors. Free US shipping over $150.',
    ...
    content: `
      ...
      <p>Free US shipping over $150. Standard delivery 7-10 business days.</p>
    `,
  },
  {
    path: '/collections/wedding-guest-outfits',
    title: 'Indian Wedding Guest Outfits — What to Wear to an Indian Wedding | LuxeMia',
    description: 'Shop Indian wedding guest outfits at LuxeMia. Sarees, anarkali suits, lehengas & salwar kameez. Free US shipping over $150.',
  ...
  },
  {
    ...
    description: 'Shop mehendi ceremony outfits at LuxeMia. Yellow & green lehengas, anarkali suits & salwar kameez. Free US shipping over $150.',
  ...
  },
  {
    ...
    description: 'Shop Eid outfits 2026 at LuxeMia. Chikankari suits, sharara sets, anarkali & lehengas in pastel & white. Free US shipping over $150.',
    h1: 'Eid Outfits 2026',
    content: `
      ...
      <p>Free US shipping over $150. Order 3-4 weeks before Eid for timely delivery.</p>
    `,
  },
  {
    path: '/collections/navratri-outfits',
    title: 'Navratri Outfits 2026 — Chaniya Choli & Garba Dress Collection | LuxeMia',
    description: 'Shop Navratri outfits 2026 at LuxeMia. Chaniya choli, garba lehengas & festive ethnic wear in all nine Navratri colours. Free US shipping over $150.',
  ...
  // ─── Programmatic SEO combo pages (25 pages) ─────────────────────────
  {
    ...
    description: 'Shop maroon lehengas for Indian wedding guests. Ready-to-ship styles from $200-$500 with free US shipping over $150. Maroon is rich, photogenic and not bridal red — perfect for wedding guests.',
    h1: 'Maroon Lehenga for Wedding Guest',
    content: '<p>Maroon is the perfect wedding guest color — rich, photogenic, and distinct from bridal red. Shop ready-to-ship maroon lehengas from $200-500 with free US shipping over $150 on orders over $150.</p><p>Shop our curated collection of maroon lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/emerald-green-lehenga-for-wedding-guest',
    title: 'Emerald Green Lehenga for Wedding Guest — Shop Ready-to-Ship | LuxeMia',
    description: 'Shop emerald green lehengas for Indian wedding guests. Rich jewel tone, photogenic, and perfect for sangeet and reception. Ready-to-ship from $200-$500 with free US shipping over $150.',
    h1: 'Emerald Green Lehenga for Wedding Guest',
    content: '<p>Emerald green is a striking wedding guest color — rich, photogenic, and pairs beautifully with gold jewelry. Shop ready-to-ship emerald green lehengas from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of emerald green lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/royal-blue-lehenga-for-wedding-guest',
    title: 'Royal Blue Lehenga for Wedding Guest — Ready-to-Ship Styles | LuxeMia',
    description: 'Shop royal blue lehengas for Indian wedding guests. Striking jewel tone, photogenic, and perfect for sangeet and reception. Ready-to-ship from $200-$500 with free US shipping over $150.',
    h1: 'Royal Blue Lehenga for Wedding Guest',
    content: '<p>Royal blue is a striking wedding guest color — bold, photogenic, and stands out in a sea of reds and pinks. Shop ready-to-ship royal blue lehengas from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of royal blue lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/pink-lehenga-for-wedding-guest',
    title: 'Pink Lehenga for Wedding Guest — From Blush to Fuchsia | LuxeMia',
    description: 'Shop pink lehengas for Indian wedding guests. From soft blush pink to bold fuchsia, ready-to-ship from $180-$450. Free US shipping over $150 on orders over $150.',
    h1: 'Pink Lehenga for Wedding Guest',
    content: '<p>Pink is the most versatile wedding guest color — from soft blush to bold fuchsia. Shop ready-to-ship pink lehengas from $180-450 with free US shipping over $150.</p><p>Shop our curated collection of pink lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/purple-lehenga-for-wedding-guest',
    title: 'Purple Lehenga for Wedding Guest — Royal & Photogenic | LuxeMia',
    description: 'Shop purple lehengas for Indian wedding guests. From deep eggplant to soft lavender, ready-to-ship from $200-$500. Free US shipping over $150 on orders over $150.',
    h1: 'Purple Lehenga for Wedding Guest',
    content: '<p>Purple is a royal, photogenic wedding guest color — from deep eggplant to soft lavender. Shop ready-to-ship purple lehengas from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of purple lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/wine-lehenga-for-wedding-guest',
    title: 'Wine Lehenga for Wedding Guest — Sophisticated & Safe | LuxeMia',
    description: 'Shop wine lehengas for Indian wedding guests. Deep, sophisticated, and distinct from bridal red. Ready-to-ship from $200-$500 with free US shipping over $150.',
    h1: 'Wine Lehenga for Wedding Guest',
    content: '<p>Wine is a sophisticated wedding guest color — deep, elegant, and safely distinct from bridal red. Shop ready-to-ship wine lehengas from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of wine lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/navy-blue-lehenga-for-wedding-guest',
    title: 'Navy Blue Lehenga for Wedding Guest — Elegant & Modern | LuxeMia',
    description: 'Shop navy blue lehengas for Indian wedding guests. Deep, elegant, and modern. Ready-to-ship from $200-$500 with free US shipping over $150 on orders over $150.',
    h1: 'Navy Blue Lehenga for Wedding Guest',
    content: '<p>Navy blue is an elegant, modern wedding guest color — deep, sophisticated, and photogenic. Shop ready-to-ship navy blue lehengas from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of navy blue lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/maroon-lehenga-for-reception',
    title: 'Maroon Lehenga for Reception — Elegant & Photogenic | LuxeMia',
    description: 'Shop maroon lehengas for Indian wedding receptions. Rich, photogenic, and perfect for evening events. Ready-to-ship from $200-$500 with free US shipping over $150.',
    h1: 'Maroon Lehenga for Reception',
    content: '<p>Maroon is an elegant choice for a wedding reception — rich, photogenic, and perfect for evening events. Shop ready-to-ship maroon lehengas from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of maroon lehenga for reception at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    ...
    content: '<p>Black is a bold, modern wedding guest choice — but check the invitation first. Some modern weddings welcome black; traditional weddings consider it inauspicious. Shop ready-to-ship black lehengas from $250-500.</p><p>Shop our curated collection of black lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/pastel-lehenga-for-wedding-guest',
    title: 'Pastel Lehenga for Wedding Guest — Soft & Modern | LuxeMia',
    description: 'Shop pastel lehengas for Indian wedding guests. Soft blush, mint, lavender, and peach — modern, romantic, and photogenic. Ready-to-ship from $180-450 with free US shipping over $150.',
    h1: 'Pastel Lehenga for Wedding Guest',
    content: '<p>Pastels are a modern, romantic wedding guest choice — soft blush, mint, lavender, and peach. Shop ready-to-ship pastel lehengas from $180-450 with free US shipping over $150.</p><p>Shop our curated collection of pastel lehenga for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/anarkali-suit-for-mother-of-bride',
    title: 'Anarkali Suit for Mother of Bride — Elegant & Comfortable | LuxeMia',
    description: 'Shop anarkali suits for the mother of the bride. Elegant, traditional, and comfortable for long wedding events. Ready-to-ship from $200-500 with free US shipping over $150.',
    h1: 'Anarkali Suit for Mother of Bride',
    content: '<p>The mother of the bride needs an outfit that is elegant, traditional, and comfortable for long wedding events. Shop anarkali suits from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of anarkali suit for mother of bride at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/lehenga-for-bridesmaid',
    title: 'Lehenga for Bridesmaid — Coordinated & Photogenic | LuxeMia',
    description: 'Shop lehengas for bridesmaids. Coordinated, photogenic, and dance-friendly for sangeet and reception. Ready-to-ship from $180-450 with free US shipping over $150.',
    h1: 'Lehenga for Bridesmaid',
    content: '<p>Bridesmaid lehengas need to be coordinated, photogenic, and dance-friendly. Shop ready-to-ship bridesmaid lehengas from $180-450 with free US shipping over $150.</p><p>Shop our curated collection of lehenga for bridesmaid at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/anarkali-suit-for-wedding-guest',
    title: 'Anarkali Suit for Wedding Guest — Easiest Indian Outfit | LuxeMia',
    description: 'Shop anarkali suits for wedding guests. The easiest Indian outfit for first-timers — slips on like a dress, no draping. Ready-to-ship from $150-400 with free US shipping over $150.',
    h1: 'Anarkali Suit for Wedding Guest',
    content: '<p>The anarkali suit is the easiest Indian outfit for wedding guests — slips on like a dress, no draping or pinning required. Shop ready-to-ship anarkalis from $150-400 with free US shipping over $150.</p><p>Shop our curated collection of anarkali suit for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/saree-for-mother-of-bride',
    title: 'Saree for Mother of Bride — Traditional & Elegant | LuxeMia',
    description: 'Shop sarees for the mother of the bride. Silk, Banarasi, and Kanchipuram — traditional, elegant, and appropriate for wedding ceremonies. Ready-to-ship from $150-500 with free US shipping over $150.',
    h1: 'Saree for Mother of Bride',
    content: '<p>The mother of the bride traditionally wears a silk saree for the wedding ceremony — elegant, timeless, and culturally appropriate. Shop ready-to-ship sarees from $150-500 with free US shipping over $150.</p><p>Shop our curated collection of saree for mother of bride at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/lehenga-for-mother-of-bride',
    title: 'Lehenga for Mother of Bride — Regal & Comfortable | LuxeMia',
    description: 'Shop lehengas for the mother of the bride. Regal, elegant, and comfortable for long wedding events. Ready-to-ship from $250-600 with free US shipping over $150.',
    h1: 'Lehenga for Mother of Bride',
    content: '<p>A lehenga for the mother of the bride should be regal, elegant, and comfortable for long wedding events. Shop ready-to-ship lehengas from $250-600 with free US shipping over $150.</p><p>Shop our curated collection of lehenga for mother of bride at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/sherwani-for-groom',
    title: 'Sherwani for Groom — Traditional & Regal | LuxeMia',
    description: 'Shop sherwanis for the groom. Traditional, regal, and photogenic for the wedding ceremony. Ready-to-ship from $200-500 with free US shipping over $150.',
    h1: 'Sherwani for Groom',
    content: '<p>The sherwani is the traditional wedding outfit for the Indian groom — regal, elegant, and photogenic. Shop ready-to-ship sherwanis from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of sherwani for groom at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/kurta-for-groom-brother',
    title: 'Kurta for Groom Brother — Stylish & Comfortable | LuxeMia',
    description: 'Shop kurtas for the groom brother. Stylish, comfortable, and appropriate for all wedding events. Ready-to-ship from $80-250 with free US shipping over $150.',
    h1: 'Kurta for Groom Brother',
    content: '<p>The groom brother needs an outfit that is stylish, comfortable, and coordinated with the wedding party. Shop ready-to-ship kurtas from $80-250 with free US shipping over $150.</p><p>Shop our curated collection of kurta for groom brother at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/sharara-for-bride-sister',
    title: 'Sharara for Bride Sister — Trendy & Photogenic | LuxeMia',
    description: 'Shop sharara sets for the bride sister. Trendy, photogenic, and dance-friendly for mehendi and sangeet. Ready-to-ship from $180-400 with free US shipping over $150.',
    h1: 'Sharara for Bride Sister',
    content: '<p>The sharara is a trendy, photogenic choice for the bride sister — wide-flare pants with a short kurti, perfect for mehendi and sangeet dancing. Shop from $180-400 with free US shipping over $150.</p><p>Shop our curated collection of sharara for bride sister at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/georgette-saree-for-reception',
    title: 'Georgette Saree for Reception — Flowy & Glamorous | LuxeMia',
    description: 'Shop georgette sarees for wedding receptions. Flowy, glamorous, and easy to drape. Ready-to-ship from $150-400 with free US shipping over $150.',
    h1: 'Georgette Saree for Reception',
    content: '<p>Georgette is the perfect reception saree fabric — flowy, glamorous, and easy to drape. Shop ready-to-ship georgette sarees from $150-400 with free US shipping over $150.</p><p>Shop our curated collection of georgette saree for reception at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/banarasi-silk-saree-for-wedding',
    title: 'Banarasi Silk Saree for Wedding — Traditional & Auspicious | LuxeMia',
    description: 'Shop Banarasi silk sarees for weddings. Handwoven in Varanasi with real zari — traditional, auspicious, and photogenic. Ready-to-ship from $200-500 with free US shipping over $150.',
    h1: 'Banarasi Silk Saree for Wedding',
    content: '<p>A Banarasi silk saree is the most traditional and auspicious choice for an Indian wedding — handwoven in Varanasi with real zari. Shop from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of banarasi silk saree for wedding at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/kanjivaram-saree-for-wedding',
    title: 'Kanjivaram Saree for Wedding — South Indian Bridal Silk | LuxeMia',
    description: 'Shop Kanjivaram silk sarees for weddings. Handwoven in Tamil Nadu with pure zari — the traditional South Indian bridal saree. Ready-to-ship from $200-500 with free US shipping over $150.',
    h1: 'Kanjivaram Saree for Wedding',
    content: '<p>The Kanjivaram silk saree is the traditional South Indian bridal saree — handwoven in Tamil Nadu with pure zari. Shop from $200-500 with free US shipping over $150.</p><p>Shop our curated collection of kanjivaram saree for wedding at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/chiffon-saree-for-wedding-guest',
    title: 'Chiffon Saree for Wedding Guest — Light & Flowy | LuxeMia',
    description: 'Shop chiffon sarees for wedding guests. Lightweight, flowy, and easy to drape. Perfect for summer weddings and daytime events. Ready-to-ship from $120-300 with free US shipping over $150.',
    h1: 'Chiffon Saree for Wedding Guest',
    content: '<p>Chiffon is the lightest, most flowy saree fabric — perfect for summer weddings and daytime events. Shop ready-to-ship chiffon sarees from $120-300 with free US shipping over $150.</p><p>Shop our curated collection of chiffon saree for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/silk-saree-for-festival',
    title: 'Silk Saree for Festival — Diwali, Navratri, Pongal | LuxeMia',
    description: 'Shop silk sarees for Indian festivals — Diwali, Navratri, Pongal, Onam. Traditional, auspicious, and photogenic. Ready-to-ship from $150-400 with free US shipping over $150.',
    h1: 'Silk Saree for Festival',
    content: '<p>A silk saree is the most traditional and auspicious choice for Indian festivals — Diwali, Navratri, Pongal, Onam. Shop from $150-400 with free US shipping over $150.</p><p>Shop our curated collection of silk saree for festival at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/organza-saree-for-engagement',
    title: 'Organza Saree for Engagement — Modern & Structured | LuxeMia',
    description: 'Shop organza sarees for engagement ceremonies. Modern, structured, and photogenic — perfect for the contemporary bride or guest. Ready-to-ship from $200-450 with free US shipping over $150.',
    h1: 'Organza Saree for Engagement',
    content: '<p>Organza is a modern, structured saree fabric perfect for engagement ceremonies — crisp, photogenic, and contemporary. Shop from $200-450 with free US shipping over $150.</p><p>Shop our curated collection of organza saree for engagement at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
    path: '/georgette-saree-for-wedding-guest',
    title: 'Georgette Saree for Wedding Guest — Easy & Elegant | LuxeMia',
    description: 'Shop georgette sarees for wedding guests. Easy to drape, elegant, and photogenic. The perfect saree for first-time wearers. Ready-to-ship from $150-350 with free US shipping over $150.',
    h1: 'Georgette Saree for Wedding Guest',
    content: '<p>Georgette is the easiest saree fabric to drape — perfect for first-time wedding guests. Flowy, elegant, and photogenic. Shop from $150-350 with free US shipping over $150.</p><p>Shop our curated collection of georgette saree for wedding guest at LuxeMia. All outfits are available in Made to Measure at no extra cost, with free US shipping over $150 on orders over $150. Ready-to-wear items dispatch in 3-5 business days; custom-stitched items in 5-7 business days; shipping takes 7-10 business days via USPS/UPS/DHL.</p><p>Related collections: <a href="/lehengas">Lehengas</a>, <a href="/sarees">Sarees</a>, <a href="/suits">Anarkali Suits</a>, <a href="/menswear">Menswear</a>, <a href="/collections/wedding-guest-outfits">Wedding Guest Outfits</a>. Read our <a href="/blog/what-to-wear-indian-wedding-non-indian-guest">complete guide for non-Indian wedding guests</a> and our <a href="/blog/indian-wedding-dress-complete-guide">Indian Wedding Dress Guide 2026</a>.</p>',
  },
  {
  ...
  },
  {
    ...
    content: '<p>Buying Indian sarees online from abroad? Learn how to spot authentic handloom, choose the right fabric, and find trusted sellers who ship to the United States.</p>',
  },
  {
  ...
  },
  {
    ...
    title: 'Shipping Indian Clothes in the USA: NRI Guide | LuxeMia',
    description: 'Complete NRI guide to shipping Indian clothes to USA, the USA. Customs, duties, delivery times & how to avoid common shipping problems.',
    h1: 'Shipping Indian Clothes in the USA: NRI Guide',
  ...
  },
  {
    ...
    title: 'Diwali Outfit Ideas for NRI Women in the United States (2026) | LuxeMia',
    ...
    h1: 'Diwali Outfit Ideas for NRI Women in the United States (2026)',
...
function generateHtml(template, route, allShopifyProducts) {
  ...
  if (route.path.startsWith('/product/') && route.product) {
    ...
    const detailRows = [
      ...
      `<li><strong>Dispatch:</strong> within 2 business days</li>`,
      ``,
    ...
    mainBodyContent = `
      ...
      <p>Free US shipping over $150. $12 flat below that. In-stock items ship within 2 business days with tracking.</p>
...
async function main() {
  ...
  for (const [handle, p] of productMap.entries()) {
    ...
    const fallbackDesc = `Shop the${colorPhrase}${fabricPhrase} ${baseTitle} at LuxeMia. Indian ethnic wear with delivery to the United States; free US shipping over $150.`;
