...
if (!SHOPIFY_STOREFRONT_TOKEN) {
  console.warn('[sitemap] WARNING: SHOPIFY_STOREFRONT_TOKEN not set — Shopify product fetch will be skipped. Set it in your environment or .env file.');
}
