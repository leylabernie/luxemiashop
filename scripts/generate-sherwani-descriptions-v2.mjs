...
function generateSeoDescription(item) {
  ...
  const candidates = [
    ...
    `${a.color_primary} ${a.fabric} sherwani with ${a.embroidery.toLowerCase()} for ${occ.toLowerCase()} — handcrafted for the modern groom. Free U.S. shipping at $135 and above to the United States.`,
