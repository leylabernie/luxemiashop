        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a href="https://instagram.com/luxemia" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background hover:bg-primary/10 rounded-full transition-colors" aria-label="Follow us on Instagram">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="https://facebook.com/luxemia" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background hover:bg-primary/10 rounded-full transition-colors" aria-label="Follow us on Facebook">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://youtube.com/@luxemia" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background hover:bg-primary/10 rounded-full transition-colors" aria-label="Subscribe on YouTube">
              ...
              <a href="https://pinterest.com/luxemia" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-background hover:bg-primary/10 rounded-full transition-colors" aria-label="Follow us on Pinterest">
